...
<div class="container mt-5">
    <div class="card shadow-lg border-0">
        <div class="card-header bg-primary text-white text-center">
            <h1 class="h3 mb-0">Tambah Pemasok</h1>
        </div>
        <div class="card-body p-4">
            ...
            <form action="<?= base_url('pemasok/store'); ?>" method="post">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan nama pemasok" required>
                </div>

                <div class="mb-3">
                    <label for="kontak" class="form-label">Kontak</label>
                    <input type="text" class="form-control" id="kontak" name="kontak" placeholder="Masukkan kontak pemasok" required>
                </div>
